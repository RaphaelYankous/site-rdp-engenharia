...
function App() {
  ...
  return (
    <div className="min-h-screen bg-engine-darker text-engine-light font-sans selection:bg-engine-primary selection:text-engine-darker overflow-x-hidden">
      ...
      {/* --- HERO SECTION COM GRID INTERATIVO (SPOTLIGHT) --- */}
      <section className="relative min-h-[90vh] md:h-screen flex items-center justify-center overflow-hidden py-12 md:py-0 bg-engine-darker">
        ...
        {/* 1. CAMADA BASE (Grade suave, sempre visível) */}
        <div
        ...
        {/* 2. CAMADA DESTAQUE (Grade brilhante que segue o mouse) */}
        <div
          className="absolute inset-0 opacity-100 pointer-events-none"
          style={{
            backgroundImage: 'radial-gradient(#FFD700 2px, transparent 2px)', // Pontos maiores e mais fortes
            backgroundSize: '40px 40px',
            // O segredo: Uma máscara que revela esta camada apenas onde o mouse está
          ...
          >
            ...
            >
              <a
                ...
                className="px-8 py-3 md:py-4 bg-engine-primary text-engine-darker font-bold rounded hover:bg-yellow-400 hover:scale-105 transition-all shadow-lg shadow-engine-primary/20 inline-block text-sm md:text-base relative z-20"
              >
                Solicitar Orçamento
              </a>
            </motion.div>
